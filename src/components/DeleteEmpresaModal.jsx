...
export default function DeleteEmpresaModal({ isOpen, onClose, onEmpresaDeleted, empresa }) {
  ...
  const handleDelete = async () => {
    ...
    setError('');
    try {
      await EmpresaApiService.deleteEmpresa(empresa.id);
      onEmpresaDeleted(empresa);
      onClose();
    } catch (err) {
